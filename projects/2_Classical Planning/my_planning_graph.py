...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, action_a: ActionNode, action_b: ActionNode):
    ...
    def _interference(self, action_a: ActionNode, action_b: ActionNode):
    ...
    def _competing_needs(self, action_a: ActionNode, action_b: ActionNode):
